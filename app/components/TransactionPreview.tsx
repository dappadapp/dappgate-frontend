...
const TransactionPreview = (
  ...
  }, [selectedHyperBridges, tokenAmountHyperBridge, mintCostData, sourceChain, bridgeCostData]);

    console.log("mintCostData", mintCostData);
    console.log("bridgeCostData", bridgeCostData);

    console.log("selectedHyperBridges", selectedHyperBridges?.length);
    console.log("tokenAmountHyperBridge", (bridgeCostData));
  return (
    <>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {ethers.formatEther(
                              BigInt(
                                (mintCostData as unknown as string) 
                              ) 
                            )}{" "}
                            {sourceChain?.symbol}
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                              ...
                              {(Number(bridgeCostData) * Number(selectedHyperBridges?.length) as unknown as string)}
                       {" "}
                       {sourceChain?.symbol}
