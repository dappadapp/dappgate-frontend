...
const Dashboard: React.FC = ({
    ...
    const { data: currentOFTMint, refetch: refechOFTMint } = useContractRead({
        ...
        args: [
            sourceChain?.tokenContractAddress
        ],
    ...
    const handleONFTBridgeFeeUpdate = async () => {
        ...
        const res = await writeContract({
            ...
            functionName: "updateBridgeFee",
            args: [
                ethers.parseEther(onftBridgeFee),
                sourceChain?.nftContractAddress
            ],
            chainId: sourceChain.chainId,
        });
    ...
    }, [currentOFTMint, currentOFTBridge, currentONFTMint,currentONFTBridge, sourceChain, onftBridgeFee, onftMintFee, mintFee, bridgeFee])
        ...
        <div className={"relative w-full h-[100vh] min-h-[800px] overflow-x-hidden"}>
            ...
            >
                ...
                <ListboxSourceMenu
                    ...
                    options={networks.filter((network) => network.setOFTContractAddress !== undefined)}
                    searchValue={searchTerm}
                    setSearchValue={setSearchTerm}
                    className="mb-10"
                />
                <div className="bg-black shadow-md rounded-lg p-6 mb-4 mt-10">
                    <h2 className="text-xl font-semibold mb-4">Contract:  <strong className="text-red-600">OFT</strong> Token SET </h2>
                    <div className="mb-2">
                        <label className="block text-white-600 mb-2 mt-3">Current Mint Fee: <strong>{currentMintFee} {sourceChain?.symbol} </strong></label>
                ...
                <div className="bg-black shadow-md rounded-lg p-6 mb-4">
                    <h2 className="text-xl font-semibold mb-2">Contract: <strong className="text-red-600">ONFT</strong> Contract SET </h2>
                    <div className="mb-2">
                        <label className="block text-white-600">Mint Fee:  <strong>{currentONFTMintFee} {sourceChain.symbol}</strong></label>
                        <div className="flex items-center">
                            <input
                                type="text"
                                value={onftMintFee}
                    ...
                    <div>
                        <label className="block text-white-600">Bridge Fee:  <strong>{currentONFTBridgeFee} {sourceChain.symbol}</strong></label>
                        <div className="flex items-center">
                            <input
                                type="text"
                                value={onftBridgeFee}
