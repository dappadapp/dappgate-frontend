      ...
      <div className={"relative w-full h-full"}>
        ...
        <div
          ...
          <div
            ...
            <div
              className={`absolute h-[80vh] aspect-square ${sourceChain.colorClass} left-0 translate-x-[-50%] rounded-full`}></div>
            <div
              className={`absolute h-[80vh] aspect-square ${targetChain.colorClass} translate-x-[50%] right-0 rounded-full`}></div>
          </div>
        </div>
      </div>
