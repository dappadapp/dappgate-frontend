...
export default function Home() {
  ...
  console.log('bridgeTxResultData', bridgeTxResultData)
    ...
    >
      ...
      >
        <div className={"container mx-auto h-full flex flex-col"}>
          ...
          <div
            className={
              "h-full w-full min-h-fit flex flex-col items-center justify-center"
            }
          >
            <div
              className={`w-full max-w-[800px] bg-white bg-opacity-5 backdrop-blur-[4px] border-white border-[2px] border-opacity-10 h-fit p-10 rounded-2xl flex flex-col ${isAnimationStarted ? "hidden" : ""}`}
            >
